						...
						if(isset($args[1])){
							if(strtolower($args[1]) == "all"){
								foreach($this->owner->getServer()->getOnlinePlayers() as $player){
									$player->sendMessage(TextFormat::BOLD . TextFormat::DARK_GRAY . "(" . TextFormat::AQUA . "!" . TextFormat::DARK_GRAY . ")" . TextFormat::RESET . TextFormat::GRAY . " Given Mask Charm");
							...
							$sender->sendMessage(TextFormat::BOLD . TextFormat::DARK_GRAY . "(" . TextFormat::AQUA . "!" . TextFormat::DARK_AQUA . ")" . TextFormat::RESET . TextFormat::GRAY . " Given Mask Charm");
